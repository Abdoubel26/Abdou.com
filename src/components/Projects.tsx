...
function Projects() {
    return ( 
    <div className="flex flex-col justify-center  max-w-screen   items-center lg:p-4 border-b-2 border-blue-600 border-dashed">
        <h1 className="text-4xl lg:text-7xl font-bold outfit my-5 ">Projects</h1>
        ...
        {projects.map((project, indx) => (
            ...
            <div className=" p-5 shadow shadow-gray-300 overflow-hidden flex flex-wrap h-40 bg-linear-to-br from-amber-100 to-amber-200 my-4 relative rounded-2xl  hover:shadow-[4px_4px_4px]  transition-all duration-200 lg:w-full  ">
                <div className='flex '> 

...
function Projects() {
    ...
    <div className="flex flex-col justify-center  max-w-screen   items-center lg:p-4">
        <h1 className="text-4xl font-bold outfit my-2 ">Projects</h1>
        <div className="flex lg:grid lg:grid-cols-3 lg:gap-3 justify-between p-2 flex-col">
        {projects.map((project, indx) => (
            <Tilt glareEnable={true} glareMaxOpacity={0.3} scale={1.03} tiltMaxAngleX={10} tiltMaxAngleY={10}>
            <div key={indx} className=" p-5 shadow-gray-500 overflow-hidden flex flex-wrap h-40 bg-linear-to-br from-amber-100 to-amber-200 shadow my-2 relative rounded-2xl  hover:shadow-[4px_4px_4px]  transition-all duration-200 lg:w-100 lg:mx-3">
                <div className='flex '> 

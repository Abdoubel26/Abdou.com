  ...
  <div className="flex items-center h-full  w-screen">
    <div className="lg:flex hidden h-118 items-center flex-col w-[50%] ">
      ...
      <div className="social-card my-2 justify-end">
        <a href="https://github.com/Abdoubel26" target="_blank">
        ...
        <a href="https://x.com/abdou_belounis" target="_blank">
        ...
        <a href="https://discord.com/users/1228788061039755276" target="_blank">
          {" "}
    ...
    <div className="flex flex-col p-2 items-center w-full lg:w-[50%]">
      {showMessage && (
        <p className="mt-1 text-sm text-green-700 py-3">
          {" "}
      ...
      >
        ...
        <div className="flex flex-col w-full items- justify-center lg:flex-row">
          <div className="flex flex-col  mx- ">
            ...
            <input
              ...
              className="rounded-full p-2 focus:outline-none bg-gray-200 text-black pl-4 lg:w-auto  outfit text-lg w-full border-black border"
            ></input>
          </div>
        ...
        <div className="flex flex-col mx-1 mt- w-full lg:my-6 justify-center items-center">
          <label className="lg:ml-11 p-1 self-start">Email</label>
          <input
            value={email}
            ...
            type="email"
            placeholder="Email"
            className="rounded-full lg:w-[86%] p-2 w-full focus:outline-none  bg-gray-200  text-black pl-4 outfit text-lg border-black border"
          ></input>
        </div>
        <div className="flex flex-col mx-1  w-full items-center justify-center  mb-3 px-1 ">
          <label className="lg:ml-11 p-1 self-start ">Message</label>
          <textarea
            value={message}
            onChange={(e) => setMessage(e.target.value)}
            rows={5}
            placeholder="Write Your Message Here"
            className="rounded-2xl p-2 lg:w-[86%] w-full focus:outline-none bg-gray-200  text-black pl-4 outfit text-lg border-black border"
          ></textarea>
        </div>
        <button
          type="submit"
          onClick={() => setShowMessage(false)}
          className=" rounded-full border-white cursor-pointer bungee border-2 text-white hover:shadow-[3px_5px_0px_rgba(0,0,0,0.3)] transition-all duration-200 active:shadow-none hover:shadow-olive-300 p-3 lg:w-[86%]  w-full bg-black"
        >
          Submit
        </button>
      </form>

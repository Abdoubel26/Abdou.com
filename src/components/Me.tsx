...
function Me() {
    ...
    return ( 
    <>
    <div className="flex border-b-2 bg-linear-to-b  from-gray-900 to-blue-950 text-white border-dotted border-b-blue-800 max-w-screen w-screen overflow-clip flex-col justify-center items-center animate-dropFade">
